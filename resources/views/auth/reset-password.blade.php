<x-guest-layout>
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-xl font-bold font-display dark:text-white text-slate-900">Setel Ulang Kata Sandi</h2>
        <p class="text-sm text-slate-400 mt-1">Masukkan alamat email Anda dan atur kata sandi baru untuk memulihkan akses dasbor.</p>
    </div>
