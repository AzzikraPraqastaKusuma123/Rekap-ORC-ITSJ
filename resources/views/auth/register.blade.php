<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="m-0 space-y-5">
        ...
        <!-- Header -->
        <div class="mb-6">
            <h2 class="text-xl font-bold font-display dark:text-white text-slate-900">Daftar Akun Baru</h2>
            <p class="text-sm text-slate-400 mt-1">Buat akun untuk memulai otomatisasi rekap struk belanja Anda.</p>
        </div>

        <!-- Name -->
        <div class="space-y-1.5">
            <label for="name" class="block text-[11px] font-bold uppercase tracking-wider text-slate-400 font-display">
                Nama Lengkap
            </label>
            <div class="relative">
                ...
                <input id="name" type="text" name="name" 
                       ...
                       class="block w-full pl-10 pr-4 py-3 rounded-xl text-sm font-medium {{ $errors->has('name') ? 'border-red-500/50' : '' }}"
        ...
        <div class="space-y-1.5" x-data="{ showPassConf: false }">
            <label for="password_confirmation" class="block text-[11px] font-bold uppercase tracking-wider text-slate-400 font-display">
            ...
            <div class="relative">
                ...
                <input id="password_confirmation" 
                       ...
                       required autocomplete="new-password"
                       class="block w-full pl-10 pr-11 py-3 rounded-xl text-sm font-medium {{ $errors->has('password_confirmation') ? 'border-red-500/50' : '' }}"
                       placeholder="••••••••">
        ...
        <div class="flex flex-col gap-3">
            ...
            <a href="{{ route('login') }}" 
               class="block text-center text-sm font-semibold text-slate-400 hover:text-white transition-colors py-2">
                Sudah terdaftar? 
                <span class="text-blue-400 font-bold hover:text-blue-300 font-display">Masuk di sini</span>
            </a>
        </div>
    </form>
</x-guest-layout>
