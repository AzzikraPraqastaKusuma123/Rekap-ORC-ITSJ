...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Space+Grotesk:wght@500;600;700&display=swap" rel="stylesheet">
        ...
        <style>
            ...
            html.light .auth-input::placeholder { color: #94a3b8; }
            ...
            html.dark input[type="text"]::placeholder { color: #475569 !important; }
            ...
            /* Label override */
            html.dark label { color: #64748b !important; }
            html.light label { color: #475569 !important; }

            /* Error text */
            .text-red-600 { color: #f87171 !important; }
            html.light .text-red-600 { color: #ef4444 !important; }
        </style>
    </head>
    <body class="antialiased">
        ...
        <div aria-hidden="true" class="pointer-events-none">
            <div class="glow-blob glow-blob-1 fixed w-[60%] h-[60%] top-[-20%] left-[-20%]" style="animation-delay:0s;"></div>
            <div class="glow-blob glow-blob-2 fixed w-[60%] h-[60%] bottom-[-20%] right-[-20%]" style="animation-delay:7s;"></div>
            <div class="glow-blob glow-blob-3 fixed w-[40%] h-[40%] top-[30%] left-[30%]" style="animation-delay:14s;"></div>
        </div>

        <!-- Theme Toggle (top right) -->
        <div class="fixed top-4 right-4 z-50">
            <button id="theme-toggle-guest" type="button"
                    class="icon-btn w-9 h-9" title="Ubah Tema">
                <svg id="icon-sun-guest" class="w-4 h-4 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m12.728 12.728l.707.707M12 8a4 4 0 100 8 4 4 0 000-8z" />
                </svg>
                <svg id="icon-moon-guest" class="w-4 h-4 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <!-- Auth Container -->
        <div class="w-full max-w-sm px-4 py-8 relative z-10 animate-scale-in">

            <!-- Brand Logo -->
            <div class="flex flex-col items-center gap-4 mb-8">
                <div class="brand-logo-icon w-16 h-16 rounded-2xl flex items-center justify-center animate-scale-in" style="animation-delay:0.1s;">
                    <svg class="w-8 h-8 text-white relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="text-center animate-fade-in-up" style="animation-delay:0.15s;">
                    <h1 class="text-2xl font-bold tracking-tight font-display">
                        <span class="dark:text-white text-slate-900">Receipt</span><span class="text-blue-500">Optima</span>
                    </h1>
                    <p class="text-[11px] font-black tracking-widest uppercase mt-1 text-slate-400 font-display">
            ...
            <!-- Footer text -->
            <p class="text-center text-[11px] text-slate-500 mt-6 font-semibold animate-fade-in" style="animation-delay:0.3s;">
                &copy; {{ date('Y') }} ReceiptOptima · PT. ITSJ Internal Tools
            </p>
        </div>
